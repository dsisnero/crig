  ...
  module Providers
    module XiaomiMimo
      ...
      struct ClientBuilder
        ...
        def initialize(@api_key : String? = nil, @base_url : String = XIAOMI_MIMO_API_BASE_URL)
        end
      ...
      struct Client
        ...
        def initialize(@api_key : String, @base_url : String = XIAOMI_MIMO_API_BASE_URL)
        end
        ...
        def self.from_val(input : String) : self
          new(input, XIAOMI_MIMO_API_BASE_URL)
        end
      ...
      struct CompletionModel
        ...
        def completion(request : Crig::Completion::Request::CompletionRequest)
          span = Crig::Span.chat_span("xiaomimimo", @model, request.preamble, nil)
