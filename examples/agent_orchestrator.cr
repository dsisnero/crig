...
module Crig::Examples::AgentOrchestrator
  ...
  ) : Crig::Extractor(Crig::Providers::OpenAI::ResponsesCompletionModel, Specification)
  ...
  def self.build_content_agent(
    client : Crig::Providers::OpenAI::Client,
    model : String = Crig::Providers::OpenAI::GPT_4,
  ) : Crig::Extractor(Crig::Providers::OpenAI::ResponsesCompletionModel, TaskResults)
  ...
  def self.run_orchestration(
    classify_agent : Crig::Extractor(Crig::Providers::OpenAI::ResponsesCompletionModel, Specification),
    content_agent : Crig::Extractor(Crig::Providers::OpenAI::ResponsesCompletionModel, TaskResults),
    judge_agent : Crig::Extractor(Crig::Providers::OpenAI::ResponsesCompletionModel, Specification),
    task_prompt : String,
  ) : Specification
